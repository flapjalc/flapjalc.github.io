...
(function($) {
  $.mbMenu = {
    ...
    version:"https://www.extinvalusa.com/javascript/menu/2.8.5rc5",
    ...
    buildMbMenu: function(op,m,type,e){
      ...
      $(this.voices).each(function(i){
        ...
        if (op.options.hasImages && !isText && !isBoxmenu){
          ...
          var imgPath=$(voice).attr("img")?$(voice).attr("img"):"blank.gif"/*tpa=https://www.extinvalusa.com/javascript/menu/blank.gif*/;
